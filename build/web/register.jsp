<%-- 
    Document   : register
    Created on : Jun 2, 2021, 9:39:33 PM
                    ...
                    <div class="item active">
                        ...
                        <div class="container">
                            ...
                            <div class="carousel-caption slide-one">
                                ...
                                <h2 class="animated fadeInLeftBig" style="color: red"><i class="fa fa-music" style="color: red"></i> Create new your account</h2>

                                <form action="registerServlet" method="post">
                                    Enter UserName: <input style="color: red" type="text" name ="user" /> <br/>
                                    Enter Password: <input style="color: red" type="text" name="pass"/> <br/>                                  
                                    <br/>
                                    &nbsp; &nbsp; &nbsp;
                                    <input type="submit" style="color: red" value="Create Account"/>
