                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="update">Update song</a></li>
                                <li><a href="AddCategoryServlet">Add Category</a></li>
                                <li><a href="DeleteServlet">Delete Category</a></li>
                                <li><a href="UpdateCategoryServlet">Update Category</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </div><!-- /.container-fluid -->
                </nav>
                        ...
                        <div class="item active">
                            ...
                            <div class="container">
                                ...
                                <div class="carousel-caption slide-one">
                                    ...
                                    <!-- button -->
                                    <a href="listSong" class="animated fadeIn btn btn-theme">Download Here</a>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="playlist-number">
                                            ...
                                            <div class="music-icon">
                                                <!--                                                <a href="audio/ConCoBeBe .mp3"><i class="fa fa-play"></i></a>
                                                                                                <a href="#"><i class="fa fa-pause"></i></a>-->
                                                <audio controls>
                                                    <source src="audio/ConCoBeBe .mp3" type="audio/mpeg">
                                                </audio>
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="events-item ">
                                    ...
                                    <div class="event-info">
                                        ...
                                        <button href="" class="btn btn-lg btn-theme" data-toggle="modal" >Book Ticket</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
