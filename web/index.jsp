                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="listSong">Explore playlists</a></li>
                                <li><a href="album">Album</a></li>                              
                                <li><a href="search.jsp">Find songs</a></li>                             
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="playlist-number">
                                            ...
                                            <div class="music-icon">
                                                ...
                                                <audio controls>
                                                    <source src="audio/TimToi.mp3" type="audio/mpeg">
                                                </audio>
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
                                        ...
                                        <li class="playlist-number">
                                            ...
                                            <div class="music-icon">
                                                ...
                                                <audio controls>
                                                    <source src="audio/Rewind.mp3" type="audio/mpeg">
                                                </audio>
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
